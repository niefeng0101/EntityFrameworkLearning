...
namespace Kengic.Was.Domain.DatabaseInterface
{
        ...
        : DbContext, IQueryableUnitOfWork
    {
        ...
        {
            Database.SetInitializer<DatabaseInterface>(null);
            //modelBuilder.Configurations.Add(new GetSapSourceTaskEntityTypeConfiguration());
