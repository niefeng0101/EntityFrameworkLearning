...
//            new ConcurrentQueueSyncDb<TKey, TEntity>(DiContainer.Current.Resolve<IQueryableUnitOfWork>());

//        public RepositoryForSyncDb()
//        {
//            Load();
...
//                LogRepository.WriteErrorLog(LogName, messageCode, item.Id.ToString());
